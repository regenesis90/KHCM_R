#' Traffic Volume Converted to Peak Hour in Weaving Section of Expressway.
#'
#' This function calculates traffic volume converted to peak hour passenger car traffic volume in weaving section of expressway.
#'    It follows <Formula 3-6> in KHCM(2013), p.68.
...
#' @export V_P_expwy_wv \code{v/(PHF * f_hv)}(pcph)
#' @examples
