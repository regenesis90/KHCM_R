#' Left Turn Traffic Volume Ratio of Integrated Lane Group Going Straight + Left + Right at Signalized Intersection
#'
#' Left turn traffic volume ratio of the integrated lane group going straight + left + right at signalized intersection.
